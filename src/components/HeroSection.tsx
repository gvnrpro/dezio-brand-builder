  ...
  return (
    <section className="min-h-screen bg-deziro-navy relative overflow-hidden">
      <nav className="absolute top-0 left-0 right-0 z-30 p-6 md:p-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-3 md:space-x-4">
            <img src="/lovable-uploads/7a23b783-7d17-42f4-b517-38dd74e29ecf.png" alt="Deziro Designs Logo" className="w-8 h-8 md:w-10 md:h-10" />
            <div className="text-white font-black text-xl md:text-2xl tracking-wide font-grotesk">DEZIRO</div>
          </div>
          <div className="flex space-x-6 md:space-x-8">
            <a href="#services" className="text-white hover:text-deziro-blue font-medium text-sm md:text-base">WORK</a>
            <a href="#contact" className="text-white hover:text-deziro-blue font-medium text-sm md:text-base">CONTACT</a>
          </div>
        </div>
      </nav>
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute top-1/2 left-1/4 w-1 h-1 bg-deziro-blue/60 rounded-full animate-ping" />
        <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-white/40 rounded-full animate-ping" />
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4 z-20">
        <div className="text-center relative max-w-6xl">
              ...
              <div key={line} className="relative overflow-hidden mb-2">
                <span
                  className={`block font-black font-grotesk transition-all duration-1200 ease-out
                    text-[clamp(2.5rem,7vw,5rem)] lg:text-[clamp(3rem,6vw,6rem)]
                  ...
                  style={{
                    ...
                    textShadow: '0 0 30px rgba(23, 125, 255, 0.5)',
                  }}
                >
                  {line}
                </span>
          ...
          <div className={`transition-all duration-1000 ease-out delay-1500 ${textVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
